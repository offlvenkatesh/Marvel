      ...
      <div className={MainStyles.MainBannerInner}>
        <div className={MainStyles.MainBannercontent}>
            <div className={MainStyles.LeftContent}>
                ...
                <div className={MainStyles.MainBannertitle}>A Universe of Super Heroes</div>
                <div className={MainStyles.Mainpara}>
All Your Favorite Stories and More. Start Streaming Now.</div>
<button className={MainStyles.MainButton}><span>STREAM NOW</span></button>
            </div>
